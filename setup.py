...
visit.field('Solidity', '["Int",[]]', 2, True, '0 for completely liquid, 5 for healthy, 10 for rocks.',False)
visit.field('Gut pain', '["Int",[]]', 5, False, '0 for no pain, 10 for screaming',False)
